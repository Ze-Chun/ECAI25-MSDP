...
class FGVP_ENSEMBLE:
    def __init__(
        ...
        self.device = device
        self.file = "580008" # "580905", "580785", "580374", "580008", "579667", "579440", "578808"

    def __call__(self, visual_prompt: str, image, centers, boxes, masks, caption):
        ...
        if 'crop' == visual_prompt or 'cpt' == visual_prompt or 'cpt_seg' == visual_prompt or 'ov_seg' == visual_prompt or 'blur_seg' == visual_prompt:
            ...
            for box, mask in zip(boxes, masks):
                ...
                if self.clip_processing == 'resize' or self.clip_processing == 'padding_R':
            ...
            for center, mask, box, boxes_center, axes_length in zip(centers, bit_masks, boxes, boxes_centers, axes_lengths):
                ...
                if 'contour' == visual_prompt:
                    ...
                    res = cv2.drawContours(res, scaled_contours, contourIdx=-1,
                                           color=str2rgb(self.color_line), thickness=self.c_thickness)
